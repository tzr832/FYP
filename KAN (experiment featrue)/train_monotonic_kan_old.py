...
from monotonic_kan_layer_old import MonotonicKANLayer
...
if __name__ == "__main__":
    ...
    if train_the_model:
        model_save_path = 'KAN (experiment featrue)/monotonic_kan_model_old.pth'
    else:
        model_save_path = f'KAN (experiment featrue)/monotonic_kan_model_old_{num_grids}{hidden_dim}.pth'
