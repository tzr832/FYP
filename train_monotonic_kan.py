...
def train(model, inputs, targets, epochs=500, lr=0.001):
    ...
    for epoch in range(epochs):
        ...
        outputs = model(inputs) / inputs[:,0:1]
...
if __name__ == "__main__":
    ...
    save_the_model = True
    load_the_model = True
    model_save_path = 'monotonic_kan_model.pth'
    ...
    # for name, param in trained_model.H_s_func.named_parameters():
    #     if name == 'w_raw':
    #         print(name, F.softplus(param))
